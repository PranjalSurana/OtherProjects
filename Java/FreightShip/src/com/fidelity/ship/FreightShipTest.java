...
//	}
	...
	@Test
	@DisplayName("calcTotalPayroll Test")
	void calcTotalPayrollTest_Success() {
		assertEquals(new BigDecimal("640000"), frieghtShip.calcTotalPayroll());
	}
	
	@Test
	@DisplayName("getCrew Test")
	void getCrewTest_Success() {
		assertEquals(crewTest, frieghtShip.getCrew());
	}
