...
describe('RESTful controller unit tests for Contact CRUD operations:', () => {
    ...
    beforeEach(() => {
        mockDao = jasmine.createSpyObj('mockDao', ['queryForAllContacts', 'queryForContact', 'createContact', 'updateContact', 'deleteContact', 'shutdown']);
    ...
    describe('create a contact', () => {
        it('succeeds', () => {
            ...
            const req = {
                body: { id: 99, firstname: 'John', lastname: "Douglas", title: "Mr.", company: "Fidelity", jobtitle: "Manager" }
            };
