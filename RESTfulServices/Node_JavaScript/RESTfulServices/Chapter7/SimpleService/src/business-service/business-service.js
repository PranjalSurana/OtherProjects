/**
 * Exercise 8.1 bonus step: you'll refactor your REST controller to 
 * delegate Widget CRUD operations to this BusinessService class.
 * 
...
class BusinessService {
    ...
    async queryForAllWidgets() {
        ...
        try {
            return await this.dao.queryForAllWidgets();
        }
        finally {
