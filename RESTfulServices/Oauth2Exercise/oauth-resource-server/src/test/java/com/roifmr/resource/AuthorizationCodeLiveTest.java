...
public class AuthorizationCodeLiveTest {
    public final static String AUTH_SERVER = "http://localhost:8083/auth/realms/roifmr/protocol/openid-connect";
    ...
    public void givenUser_whenUseFooClient_thenOkForFooResourceOnly() {
        ...
        final Response fooResponse = RestAssured.given().header("Authorization", "Bearer " + accessToken).get(RESOURCE_SERVER + "/warehouse/widgets/1");
